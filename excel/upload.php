...
if (move_uploaded_file($userfile_tmp, $uploaddir . $userfile_name)) {
  header('Location: index.html?uploadDone=1&fileName='.$_FILES['userfile']['name']."&column=".$_POST["column"]."&row=".$_POST["row"]."&columnCoord=".$_POST["columnCoord"]);
}else{
